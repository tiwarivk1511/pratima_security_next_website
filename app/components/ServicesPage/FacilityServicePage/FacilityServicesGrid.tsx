...
const FACILITY_SERVICES = [
  { id: 1, category: "Soft Services", title: "Premium Housekeeping", desc: "Maintaining pristine environments through mechanized cleaning, waste management, and specialized floor care protocols.", icon: <Brush size={24} />, image: "https://sih.edu.sg/wp-content/uploads/The-Multifaceted-Role-of-Housekeeping-in-the-Hospitality-Industry.jpg" },
  { id: 2, category: "Hard Services", title: "Technical Maintenance", desc: "Comprehensive HVAC, electrical, and plumbing upkeep. Our certified engineers ensure zero downtime for your critical facility infrastructure.", icon: <Settings size={24} />, image: "https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?q=80&w=2070&auto=format&fit=crop" },
  { id: 3, category: "Soft Services", title: "Horticulture & Landscaping", desc: "Enhancing your workspace aesthetics with professional garden maintenance, indoor plants management, and sustainable green-cover solutions.", icon: <Leaf size={24} />, image: "https://images.unsplash.com/photo-1557429287-b2e26467fc2b?q=80&w=2070&auto=format&fit=crop" },
  { id: 4, category: "Support Services", title: "Pantry & Cafeteria", desc: "Managed food and beverage services focusing on hygiene, nutrition, and professional hospitality for staff and executive guests.", icon: <Coffee size={24} />, image: "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?q=80&w=2070&auto=format&fit=crop" },
  { id: 5, category: "Hard Services", title: "Fire & Life Safety", desc: "Regular auditing and maintenance of fire suppression systems, alarms, and emergency protocols to ensure a 100% compliant and safe facility.", icon: <Zap size={24} />, image: "https://www.electronicsecuritycorp.com/wp-content/uploads/2023/02/Fire-life-safety-banner-scaled.jpg" },
  { id: 6, category: "Support Services", title: "Admin & Helpdesk", desc: "Streamlined front-office management, mailroom services, and centralized helpdesk support to optimize daily business operations.", icon: <Users2 size={24} />, image: "https://images.unsplash.com/photo-1497215842964-222b430dc094?q=80&w=2070&auto=format&fit=crop" }
];
...
const FacilityServicesGrid = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const enquiriesRef = ref(rtdb, 'facility_enquiries');
      ...
      setFormData({ fullName: '', company: '', phone: '', email: '', address: '', service: '', requiredDate: '' });
      setOpen(false);
    } catch (error) {
      ...
      >
        <DialogContent sx={{ p: { xs: 3, md: 6 } }}>
          <div className="flex justify-between items-start mb-10">
            ...
            <IconButton onClick={handleClose} disabled={loading} className="hover:rotate-90 transition-all duration-300 bg-slate-100 p-2">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="py-1">
              <TextField fullWidth label="Site / Facility Address *" variant="filled" multiline rows={2} required sx={inputStyle} 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <FormControl fullWidth variant="filled" sx={inputStyle} required>
                ...
                >
                  ...
                  <MenuItem value="Full Facility Audit" sx={{ fontWeight: 600 }}>Full Facility Audit</MenuItem>
                </Select>
              </FormControl>

              <TextField 
                fullWidth label="Required From Date" type="date" variant="filled" required 
                InputLabelProps={{ shrink: true }} sx={inputStyle} 
                value={formData.requiredDate} onChange={(e) => setFormData({...formData, requiredDate: e.target.value})}
              />
            </div>
